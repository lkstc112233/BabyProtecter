...
import net.muststudio.babyprotecter.R;
import net.muststudio.babyprotecter.Settings;
...
public class JimmySettings extends ColoredGuiItemContainer {
	Calendar calendar = Calendar.getInstance();
	TextEditControl n;
	TextEditControl a;

	public JimmySettings() {
		...
		addToList(new GenericButton(new RelativePoint(0.075, 0.69), new RelativePoint(0.925,
			...
			public void task() {
				...
				new TimePickerDialog(JimmyActivity.getActivity(),
