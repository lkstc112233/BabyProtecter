...
import net.muststudio.babyprotecter.BluetoothTemperatureSource;
import net.muststudio.babyprotecter.JimmyActivity;
import net.muststudio.babyprotecter.JimmyAlarmer;
import net.muststudio.babyprotecter.util.Waitter;
...
public class TemperatureViewer extends SquareGuiItem {
	...
	public TemperatureViewer(RelativePoint left_up, RelativePoint right_bottom) {
		...
		if (JimmyActivity.getActivity().bleEnabled)
